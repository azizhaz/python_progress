These source codes are used implement data encoding before proceed the dataset into Feature Selection Method to choose some variables for classification (Machine Learning).
